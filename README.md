...
Clone this repository, install dependencies. To obtain -logk aqueous radio(photo)lytic constant update the smiles and the experimental parameters in predict_mlogk.py, save the changes and run:

```bash
python predict_mlogk.py
